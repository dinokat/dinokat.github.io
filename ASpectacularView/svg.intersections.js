...
(function(root, factory){
    ...
    SVG.extend(SVG.Line, {
        ...
        /**
         * SVG.Line -> SVG.Path intersection delta
         * @ignore
         * @param   {Object} line - SVG.Line element
         * @returns {Number|undefined}
         */
        distanceToLineIntersect: function(line){
            //return linePos_linePos(fromLineToLinePos(this), fromLineToLinePos(line));
            return linePos_linePos_delta(fromLineToLinePos(this), fromLineToLinePos(line))
        }
    ...
    /**
     * Get distance to intersection point for 2 lines depending on their start&end position points.
     * {@link http://jsfiddle.net/justin_c_rounds/Gd2S2/|Original function}
     *
     * @function linePos_linePos_delta
     *
     * @param    {Position} line1Pos - First line start&end position
     * @param    {Position} line2Pos - Second line start&end position
     * @returns  {Number|undefined}   - Intersection point or undefined
     */
    function linePos_linePos_delta(line1Pos, line2Pos){
        ...
        var line1StartX = line1Pos.x1,
            ...
            intersect,// = linePos_linePos_delta(line1Pos, line2Pos),
            intersectX,// = intersect.x,
            intersectY;

        intersect = linePos_linePos(line1Pos, line2Pos);
        ...
        distance = lengthBetweenTwoPoints(line1StartX, line1StartY, intersectX, intersectY );
    ...
    return {
        ...
        linePos_linePos_delta : linePos_linePos_delta,
